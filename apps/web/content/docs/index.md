...
> **Philosophy:** **Lightweight & Fast Build**: mango is designed to be minimal yet functional. It compiles in seconds and offers a robust set of features out of the box.

## Feature Highlights

Beyond basic window management, mangowm provides a rich set of features designed for a modern Wayland experience.

- **[Fluid Animations](/docs/visuals/animations)** — Smooth, customizable animations for opening, moving, and closing windows, as well as tag switching.
- **[Flexible Layouts](/docs/window-management/layouts)** — Supports Scroller, Master-Stack, Monocle, Grid, Deck, and more, with per-tag layouts.

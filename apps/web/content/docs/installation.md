...
> **⚠️ Warning — Requires sudo privileges:** Both commands require root privileges. Use `sudo` if needed.
...
> **ℹ️ Info — Build Dependencies:** Ensure the following dependencies are installed before proceeding:
> - `glibc`
> - `wayland`
> - `wayland-protocols`
> - `libinput`
